export const MEMBER_TABS = ["전체", "개발팀", "디자인팀", "마케팅팀", "영업팀", "운영팀"] as const;
export type MemberTab = typeof MEMBER_TABS[number];

export const MEMBER_TAB_ACTIONS: Record<MemberTab, { label: string; variant: "primary" | "danger" | "ghost" }[]> = {
  전체:      [],
...
export const MEMBER_COMPANIES = ["주식회사 예시", "테크코리아", "디지털솔루션", "한국IT"];
